            ...
            <>
                ...
                <div className="container text-left rounded mt-4 p-2 ">
                                ...
                                <tbody>
                                    {
                                        ...
                                        surveys.map((e, index) => (
                                            <tr key={index} className="clickable-row">
                                                ...
                                                <td> <Link to={"/teacher/survey-management/view/"+e.key}>{e.title}</Link></td>
                                                ...
                                                <td style={{maxWidth: "220px"}}>
                                                    ...
                                                    <Link to={"/teacher/survey-management/view/"+e.key}><button className="btn btn-sm btn-secondary ml-2">View Responses</button></Link>
                    ...
                    <div className="row mt-2 justify-content-center">
                        <div className="col-2">
                            <Link to="/teacher/survey-management/create">
